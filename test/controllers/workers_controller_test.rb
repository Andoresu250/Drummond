...
class WorkersControllerTest < ActionController::TestCase
  ...
  test "should create worker" do
    assert_difference('Worker.count') do
      post :create, worker: { cc: @worker.cc, first_name: @worker.first_name, last_name: @worker.last_name }
    end
  ...
  test "should update worker" do
    patch :update, id: @worker, worker: { cc: @worker.cc, first_name: @worker.first_name, last_name: @worker.last_name }
    assert_redirected_to worker_path(assigns(:worker))
  end
